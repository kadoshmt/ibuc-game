...
const InfoModal: React.FC<InfoModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50">
      <div className="bg-white border-4 border-orange-500 rounded-lg p-6 max-w-xl mx-auto text-center">
        <div className="mb-4">
          <Image
        ...
        <p className="text-gray-800 mb-6">
          Este jogo foi criado por Janes Roberto da Costa (Assembleia de Deus - Alvorada, Cuiabá/MT) para auxiliar os alunos e professores do Curso de Teologia Infantil do IBUC (Instituto Bíblico Único Caminho). 
